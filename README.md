...
I build backend services, REST APIs and integrations, work with business-critical application logic, databases and asynchronous processing. I pay particular attention to clear service boundaries, maintainable code, predictable behavior and pragmatic architecture.
...
* External service and payment integrations
...
* Extensible payment processor integration
